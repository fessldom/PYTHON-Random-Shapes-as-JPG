...
while imageid < runs:
    ...
    # x and y values for the first point, can be changed at will
    p1_coord1 = random.randint(5,245)     
    p1_coord2 = random.randint(5,245)  
    
    # x and y values for the second point, can be changed at will
    p2_coord1 = random.randint(5,495)     
    p2_coord2 = random.randint(250,495)
    
    # x and y values for the third point, can be changed at will
    p3_coord1 = random.randint(250,495)     
    p3_coord2 = random.randint(5,245)
    
    # shape being drawn onto the file
    draw.polygon(((p1_coord1, p1_coord2), (p2_coord1, p2_coord2), (p3_coord1,p3_coord2)), fill=(color_R, color_G, color_B), outline=(0, 0, 0))
    
    # here is the filename, change to what you want, includes number of image generated
    file_out = "triangle" + str(imageid) + ".jpg"
